...
from caching.CacheRedis import RedisManager
from service_triage_category.algos.pyreason.algo_triage_basic.AlgoTriageScoreInteraction import TriageScoreInteraction
from services.models.Models import TriageInteractionRequest
from services.service_triage.factory.FactoryAlgoTriage import TriageAlgoName, TriageFactory
from utils.Utils import load_env_file
...
async def rate_response(
    ...
    try:
        ...
        triage = TriageInteractionRequest(request_id=body.request_id, params=body.params)
        ...
        bir = TriageScoreInteraction(thresholds={}).run_triage_algo(triage_interaction_request=triage)
